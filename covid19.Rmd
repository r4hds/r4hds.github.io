...
```{r include = FALSE}
knitr::opts_chunk$set(collapse = TRUE, comment = NA, tidy = FALSE, echo = F)
source("./covid19.R")
```
...
The `Top 10 Countries` plot shows the trend across the top most hit countries excluding China and Italy to allow for better appreciation of the trend in these countries.  
